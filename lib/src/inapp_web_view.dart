...
import '../constants/pwa_constants.dart';
import '../util.dart';
import '../webview_popwindow.dart';
...
class _InAppWebViewWidgetState extends State<InAppWebViewWidget> with WidgetsBindingObserver {
  ...
  InAppWebViewSettings sharedSettings = InAppWebViewSettings(
      ...
      applicationNameForUserAgent: 'CARPARTS MOBILE WRAP',
